...
#back-to-top{position:fixed;bottom:40px;right:13px;z-index:9999;width:32px;height:32px;text-align:center;line-height:30px;background:#f5f5f5;color:#444;cursor:pointer;border-radius:2px;text-decoration:none;opacity:0;transition:opacity .2s ease-out;border:1px solid #ddd;}
...
<div class="table-list">
   <form name="myform"  id="myform" action="__URL__/del" method="POST">
	...
	<div class="btn" style="font-size:12px;">
     ...
     <input type="button" id="ysten_gid" value="同步" class="coolbg" style="line-height:22px;"/>&nbsp;
<!--      <a href="javascript:void(0)" id="ysten_gid" class="coolbg">同步</a>&nbsp; -->
     
     &nbsp;<input type="button" id="del" value="删除" class="coolbg" style="line-height:22px;"/>  </label>
