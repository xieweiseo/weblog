...
<link href="__PUBLIC__/admin/top.css" rel="stylesheet" type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="__PUBLIC__/admin/images/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="__PUBLIC__/admin/images/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" class="weco">
        	您好<span class="username"> : <?php echo (session('loginUserName')); ?></span>，欢迎进入行业运营管理平台！
        	[<a href="__GROUP__/User/password"  target="main" >修改密码</a>]
      ...
      <tr>
		...
		<dl id="tpa">	
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'m',1);" onMouseOut="mv(this,'o',1);"><a href="__GROUP__/Public/menu/" onclick="changeSel(1)" target="menu" title="主菜单">主菜单</a></div></dd>
	    <dd><div class='item' id='item2' onMouseMove="mv(this,'m',2);" onMouseOut="mv(this,'o',2);"><a href="__GROUP__/Hotel/index" onclick="changeSel(2)" target="main">酒店管理</a></div></dd>
        <dd><div class='item' id='item8' onMouseMove="mv(this,'m',8);" onMouseOut="mv(this,'o',8);"><a href="__GROUP__/Device/panel" onclick="changeSel(8)" target="main">面板查询</a></div></dd>
		<dd><div class='item' id='item4' onMouseMove="mv(this,'m',4);" onMouseOut="mv(this,'o',4);"><a href="__GROUP__/Clear/clear" onclick="changeSel(4)" target="main" title="缓存清理">缓存清理</a></div></dd>
		<dd><div class='item' id='item5' onMouseMove="mv(this,'m',5);" onMouseOut="mv(this,'o',5);"><a href="__GROUP__/Public/main" onclick="changeSel(5)" target="main">系统信息</a></div></dd>
		</dl>
		</td>
      </tr>
    </table></td>
